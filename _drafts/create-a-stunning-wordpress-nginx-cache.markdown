---
layout: post
title: "Creating a stunning Wordpress Nginx cache"
subtitle: "Nginx + PHP5-FPM + FastCGI == fast!"
date: 2015-05-28 12:08:00
categories: blog
image: "/assets/images/nginx-php-fpm-cache.png"
...
In my exceptions I've added ``wp-login.php``. We cant test this by running the following command:
